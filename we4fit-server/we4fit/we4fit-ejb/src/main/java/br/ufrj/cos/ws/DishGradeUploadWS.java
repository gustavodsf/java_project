...
import br.ufrj.cos.entity.PhotoMetadaEntityBeanInterface;
import br.ufrj.cos.pojo.PhotoMetada;

@Path("/upload")
@Stateless
public class DishGradeUploadWS {
	
	@EJB(name="photoMetadaEntityBean")
	PhotoMetadaEntityBeanInterface photoMetadaEntityBean;
	
	private final String UPLOADED_FILE_PATH = "/home/fnx/we4fit/photo/";
	...
	public Response uploadPhoto(MultipartFormDataInput input) {
		...
		for (InputPart inputPart : inputParts) {
			...
			try {
				...
				PhotoMetada photoMetada = new PhotoMetada(fileName);
